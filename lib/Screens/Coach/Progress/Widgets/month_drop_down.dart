...
class PreviousMonthDropDown extends StatefulWidget {
  final List<String> options;
  final Function(String?) onOptionSelected;
  final String? selectedOption;

  const PreviousMonthDropDown({
    Key? key,
  ...
  @override
  State<PreviousMonthDropDown> createState() => _DropDownState();
}

class _DropDownState extends State<PreviousMonthDropDown> {
